...
- **Web & Backend** - Django/Flask, React, PostgreSQL, Docker
...
**[llm-discord-bot](https://github.com/AndreiGhita2002/llm-discord-bot)** — Discord chatbot with local LLM inference (Ollama) featuring semantic memory recall via embeddings and probabilistic user summaries.

**[XR Pirate Purgatory](https://github.com/UofG-XR-Group3-2025/xr-pirate-purgatory)** - VR escape room where you are a pirate trying to escape the afterlife. 

**[plane-game](https://github.com/AndreiGhita2002/plane-game)** — 1st place winner at the GUTS 2025 hackathon (Free to Book challenge).
